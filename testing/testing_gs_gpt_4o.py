...
# gender_specific_questions.to_csv('data/gender_specific_questions_gpt_4o.csv', index=False, encoding='utf-8')

# print("LLM answers have been generated and saved in 'answer_llm' column for the gender_specific_questions DataFrame.")
# print("The updated CSV has been saved to 'data/gender_specific_questions_gpt_4o.csv'.")
...
gender_specific_questions = pd.read_csv('data/gender_specific_questions_gpt_4o.csv', encoding='utf-8')
