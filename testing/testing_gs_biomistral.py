...
gender_specific_questions.to_csv('data/gender_specific_questions_biomistral.csv', index=False, encoding='utf-8')

print("LLM answers have been generated and saved in 'answer_llm' column.")
print("The updated CSV has been saved to 'data/gender_specific_questions_biomistral.csv'.")
