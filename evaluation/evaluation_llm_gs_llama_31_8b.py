...
df_melted.to_csv('data/evaluated_responses_gs_llama_31_8b.csv', index=False)

print("Evaluation complete. Results saved to 'data/evaluated_responses_gs_llama_31_8b.csv'.")
