...
gender_specific_questions = pd.read_csv('data/gender_neutral_questions_gpt_35.csv', encoding='utf-8')
...
df_melted.to_csv('data/evaluated_responses_gn_3.5.csv', index=False)

print("Evaluation complete. Results saved to 'data/evaluated_responses_gn_3.5.csv'.")
