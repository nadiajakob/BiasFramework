...
gender_specific_questions = pd.read_csv('data\gender_specific_questions_biomistral.csv', encoding='utf-8')
...
df_melted.to_csv('data/evaluated_responses_gs_biomistral.csv', index=False)

print("Evaluation complete. Results saved to 'data/evaluated_responses_gs_biomistral.csv'.")
