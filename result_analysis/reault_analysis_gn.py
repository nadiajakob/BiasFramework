...
df_3_5 = pd.read_csv('data/evaluated_responses_gn_3.5.csv', encoding='utf-8')
df_4o = pd.read_csv('data/evaluated_responses_gn_4o.csv', encoding='utf-8')
df_llama_8b = pd.read_csv('data/evaluated_responses_gn_llama_31_8b.csv', encoding='utf-8')
