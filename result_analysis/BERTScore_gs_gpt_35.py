...
df_final = pd.read_csv("data/framework_alignment_gs_gpt_35.csv", encoding="utf-8")
...
df_final.to_csv("data/framework_alignment_BERT_gs_gpt_35.csv", index=False, encoding="utf-8")
