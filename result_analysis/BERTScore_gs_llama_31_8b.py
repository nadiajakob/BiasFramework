...
df_final = pd.read_csv("data/framework_alignment_gs_llama_31_8b.csv", encoding="utf-8")
...
df_final.to_csv("data/framework_alignment_BERT_gs_llama_31_8b.csv", index=False, encoding="utf-8")
