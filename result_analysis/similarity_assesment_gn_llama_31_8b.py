...
# B) Framework answers
df_framework = pd.read_csv("data\gender_neutral_questions_llama_31_8b.csv", encoding='utf-8')
...
# Save to CSV
df_final.to_csv("data/framework_alignment_gn_llama_31_8b.csv", index=False, encoding='utf-8')
