...
# B) Framework answers
df_framework = pd.read_csv("data/gender_specific_questions_gpt_35.csv", encoding='utf-8')
...
# Save to CSV
df_final.to_csv("data/framework_alignment_gs_gpt_35.csv", index=False, encoding='utf-8')
