...
df_final = pd.read_csv("data/framework_alignment_gn_gpt_35.csv", encoding="utf-8")
...
df_final.to_csv("data/framework_alignment_BERT_gn_gpt_35.csv", index=False, encoding="utf-8")
